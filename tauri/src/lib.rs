...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Mesh — multi-agent canvas feature
            ipc::mesh::mesh_create_floor,
            ipc::mesh::mesh_list_floors,
            ipc::mesh::mesh_rename_floor,
            ipc::mesh::mesh_delete_floor,
            ipc::mesh::mesh_create_template,
            ipc::mesh::mesh_list_templates,
            ipc::mesh::mesh_update_template,
            ipc::mesh::mesh_delete_template,
            ipc::mesh::mesh_create_graph,
            ipc::mesh::mesh_list_graphs,
            ipc::mesh::mesh_set_graph_entry,
            ipc::mesh::mesh_set_graph_provider,
            ipc::mesh::mesh_delete_graph,
            ipc::mesh::mesh_add_node,
            ipc::mesh::mesh_move_node,
            ipc::mesh::mesh_resize_node,
            ipc::mesh::mesh_remove_node,
            ipc::mesh::mesh_list_nodes,
            ipc::mesh::mesh_add_edge,
            ipc::mesh::mesh_remove_edge,
            ipc::mesh::mesh_list_edges,
            ipc::mesh::mesh_note_create,
            ipc::mesh::mesh_note_get,
            ipc::mesh::mesh_note_list,
            ipc::mesh::mesh_note_set_content,
            ipc::mesh::mesh_note_rename,
            ipc::mesh::mesh_save_annotations,
            ipc::mesh::mesh_list_annotations,
            ipc::mesh::mesh_list_skills,
            ipc::mesh::mesh_read_skill,
            ipc::mesh::mesh_create_run,
            ipc::mesh::mesh_finish_run,
            ipc::mesh::mesh_record_run_session,
            ipc::mesh::mesh_list_run_sessions,
            ipc::mesh::mesh_find_active_run,
        ])
